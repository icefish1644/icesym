...
class anglePlots(wx.Dialog):
    ...
    def __set_properties(self):
		...
		self.SetTitle("Angle Plots")
		self.SetSize((275, 450))
		for i in self.data:
    ...
    def __do_layout(self):
        # begin wxGlade: anglePlots.__do_layout
		grid_sizer = wx.FlexGridSizer(2, 1, 10, 10)
		grid_sizer_buttons = wx.FlexGridSizer(1, 2, 0, 0)
		grid_sizer_configure = wx.FlexGridSizer(6, 2, 10, 10)
    ...
    def setParameters(self,plotData):
		...
		#self.data['rpm'] = wx.ListBox(self.panel_configure,choices=plotData['rpm'], style=wx.LB_MULTIPLE)
		...
		#self.data['cycle'] = wx.Choice(self.panel_configure,choices=plotData['cycle'])
		self.data['cycle'] = wx.CheckListBox(self.panel_configure,choices=plotData['cycle'],size=(100,60))
		#self.data['cycle'].SetStringSelection(str(plotData['cycle'][-1]))
