...
class formTank(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.SetSize(wx.DLG_UNIT(self, wx.Size(212, 168)))
        ...
        self.button_5_copy.SetMinSize(wx.DLG_UNIT(self.button_5_copy, wx.Size(16, 12)))
        ...
        self.data['Cd_ports'].SetMinSize(wx.DLG_UNIT(self.data['Cd_ports'], wx.Size(70,100)))
        ...
        self.notebook_general.SetMinSize(wx.DLG_UNIT(self.notebook_general, wx.Size(258, 1344)))
        ...
        self.data['state_ini'].SetMinSize(wx.DLG_UNIT(self.data['state_ini'], wx.Size(160, 128)))
    ...
    def __do_layout(self):
        ...
        grid_sizer_8.Add(self.data['Cd_ports'], 0, wx.EXPAND|wx.SHAPED, 0)
